...
class YlSpider05(scrapy.Spider):
    name = 'ylSpider05'
                            ...
                            for flight in v:
                                ...
                                if not icsf:
                                    ...
                                    if phoenix_rule_id.__eq__("00000"):
                                        ...
                                        _data = [company, company_no, plane_no, start_time, end_time, from_city, _from_city_code, to_city, _to_city_code, create_time, str(discount[0]), flight_time, platform, str(price), flight_type, plane_type, flight_transfer, from_city_airport, to_city_airport, self.task_time, ip_map[int(self.redis_items['db'])], count]
    ...
    def parse_lowest_price(self, meta_data: dict) -> list:
        global gnjpapp_head, server_session_id, link_tracker_id
        gnjpapp_head, server_session_id, link_tracker_id = None, "", ""
                ...
                with httpx.Client(headers=headers) as client:
                    ...
                    if res.status_code in [200, 201]:
                        ...
                        if len(sell_price) == 0:
                            ...
                            return [company, company_no, plane_no, start_time, end_time, from_city, from_city_code, to_city, to_city_code, create_time, str(discount[0]), off_date, platform, str(price), flight_type, plane_type, flight_transfer, from_city_airport, to_city_airport, self.task_time, ip_map[int(self.redis_items['db'])], count]
                    else:
                        self.fail += 1

...
class YlFile:
    def __init__(self, basePath):
        ...
        self.reafConfig('flight_spider_config.ini')
    ...
    def reafConfig(self, name):
        self.cf.read(self._basePath + os.sep + 'config' + os.sep + name)

    def getConfigDict(self, name):
        return dict(self.cf.items(name))

    def getLogName(self, logDir, logName):
        logPath = os.path.join(self._basePath, logDir)
